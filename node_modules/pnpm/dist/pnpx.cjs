...
// ../../node_modules/.pnpm/@babel+highlight@7.17.9/node_modules/@babel/highlight/lib/index.js
var require_lib2 = __commonJS({
  "../../node_modules/.pnpm/@babel+highlight@7.17.9/node_modules/@babel/highlight/lib/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
var require_lib4 = __commonJS({
  "../cli-meta/lib/index.js"(exports2) {
    "use strict";
    ...
    var defaultManifest = {
      name: process.env.npm_package_name != null && process.env.npm_package_name !== "" ? process.env.npm_package_name : "pnpm",
      version: process.env.npm_package_version != null && process.env.npm_package_version !== "" ? process.env.npm_package_version : "0.0.0"
    };
    var pkgJson;
    if (require.main == null) {
      ...
      try {
        pkgJson = {
          ...defaultManifest,
          ...load_json_file_1.default.sync(path_12.default.join(path_12.default.dirname(require.main.filename), "../package.json"))
        };
      } catch (err) {
        pkgJson = defaultManifest;
      }
    ...
    var packageManager = {
      name: pkgJson.name,
      stableVersion: pkgJson.version.includes("-") ? pkgJson.version.substr(0, pkgJson.version.indexOf("-")) : pkgJson.version,
      version: pkgJson.version
    };
    exports2.default = packageManager;
  }
});
...
(async () => {
  ...
  process.env["npm_config_user_agent"] = `${cli_meta_1.default.name}/${cli_meta_1.default.version} npm/? node/${process.version} ${process.platform} ${process.arch}`;
  if (workspaceRoot) {
